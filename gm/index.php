      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			...
			<th><h4 class="text-green">(( Pimpinan ))</h4>
			</th>
          ...
          <ul class="sidebar-menu">
			...
			<ul class="treeview-menu">
				...
				<li><a href='?module=laporan&aksi=daftar_prestasi' ><i class="glyphicon glyphicon-thumbs-up"></i><span>Prestasi</span></a></li>
			</ul>
			</li>
	...
	<?php include "isi.php";?>        		
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Kepegawaian PT. mila sejahtera<b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2015 <a href="#">SanFadhly</a>.</strong> All rights reserved.
