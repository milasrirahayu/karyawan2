      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			<table>
			<tr>
			<td rowspan="3"><img src="../aset/dist/img/res.jpg"style="margin-right:15px;width:45px;height:45px;" class="img-circle" alt="User Image" /></td>
			<th><h4 class="text-blue">(( HRD ))</h4>
			</th>
			
			<tr>
			<td><i class="text-blue">
				<a href="index.php?module=edit_user&id_user=<?php echo $_SESSION['id'];?>" class="btn btn-xs btn-primary ">&nbsp;<i class="fa fa-user"></i>&nbsp;</a> 
				&nbsp;&nbsp;
         ...
         <ul class="sidebar-menu">
			...
			<li><a href="?module=home"><i class="fa fa-home"></i> <span>Ber anda</span></a></li>			
			<li><a href='?module=pegawai' ><i class="fa fa-user-md"></i><span>Daftar Pegawai</span></a></li>
